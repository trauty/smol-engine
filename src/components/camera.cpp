...
{   
    ...
    void camera_ct::update(f64 delta_time)
    {
        ...
        glm_vec3_add(pos.data, forward.data, dir.data);
        glm_look(pos.data, dir.data, up.data, view_matrix.data);
        glm_perspective(fov, aspect, near_plane, far_plane, projection_matrix.data);
    }
