...
{   
    ...
    {
        glmc_vec3_copy(pos.data, local_position.data);
        mark_local_dirty();
    }
    ...
    {
        glmc_vec3_copy(scale.data, local_scale.data);
        mark_local_dirty();
    }
    ...
    {
        vec3 angles;
        glmc_euler_angles(cached_local_matrix.data, angles);
        return vec3_t { 
    ...
    vec3_t transform_ct::get_forward()
    {
        ...
        glmc_vec3_normalize(forward.data);
        return forward;
    }
    ...
    vec3_t transform_ct::get_right()
    {
        ...
        glmc_vec3_normalize(right.data);
        return right;
    }
    ...
    void transform_ct::set_world_position(vec3_t& pos)
    {
        if (transform_ct* parent_transform = get_parent_transform())
        {
            ...
            glmc_mat4_inv(wm_inv.data, wm_inv.data);
            glmc_mat4_mulv3(wm_inv.data, pos.data, 1.0f, local_position.data);
        }
        else
        {
            glmc_vec3_copy(pos.data, local_position.data);
    ...
    void transform_ct::set_world_rotation(quat_t& rot)
    {
        if (transform_ct* parent_transform = get_parent_transform())
        {
            ...
            glmc_quat_inv(rot_inv.data, rot_inv.data);
            glmc_quat_mul(rot_inv.data, rot.data, local_rotation.data);
        }
        else
        {
            glmc_quat_copy(rot.data, local_rotation.data);
        }
    ...
    void transform_ct::set_world_scale(vec3_t& scale)
    {
        if (transform_ct* parent_transform = get_parent_transform())
        {
            ...
            glmc_vec3_div(scale.data, parent_scale.data, local_scale.data);
        }
        else
        {
            glmc_vec3_copy(scale.data, local_scale.data);
    ...
    void transform_ct::set_world_euler_angles(vec3_t& angles)
    {
        ...
        quat_t quat;
        glmc_euler_xyz_quat(angles_rad.data, quat.data);
        set_world_rotation(quat);
    }

    void transform_ct::translate_local(vec3_t& val)
    {
        glmc_vec3_add(local_position.data, val.data, local_position.data);
        mark_local_dirty();
    }
    ...
    void transform_ct::rotate_local(vec3_t& euler)
    {
        ...
        vec4 dq;
        glmc_euler_yxz_quat(r, dq);
        glmc_quat_mul(local_rotation.data, dq, local_rotation.data);
        glm_quat_normalize(local_rotation.data);
        mark_local_dirty();
    ...
    {
        glmc_vec3_mul(local_scale.data, scale.data, local_scale.data);
        mark_local_dirty();
    }
    ...
    {
        mat4_t t, r, s, trs;
        glmc_translate_make(t.data, local_position.data);
        glmc_quat_mat4(local_rotation.data, r.data);
        glmc_scale_make(s.data, local_scale.data);

        glmc_mat4_mul(r.data, s.data, trs.data);
        glmc_mat4_mul(t.data, trs.data, cached_local_matrix.data);
